...
class CalendarDay extends Component {
  ...
  render() {
    ...
    const todayHighlightStyle = isToday ? styles.highlightTodayStyle : {}; // Apply highlight if today
    ...
    // Apply todayHighlightStyle conditionally
    _dateViewStyle.push(todayHighlightStyle);
